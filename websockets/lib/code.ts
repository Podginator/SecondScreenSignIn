...
export function deleteConnection(connectionId: string): Promise<void> {
  return getKeyForConnectionId(connectionId)
    .then(deleteLoginCode);
}

function deleteLoginCode(loginMap: ClientLoginCodeMap): Promise<void> {
...
export function getKeyForConnectionId(connectionId: string): Promise<ClientLoginCodeMap> {
